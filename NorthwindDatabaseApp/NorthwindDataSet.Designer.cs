        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            public EmployeesRow AddEmployeesRow(
                ...
                if ((parentEmployeesRowByFK_Employees_Employees != null)) {
                    columnValuesArray[17] = parentEmployeesRowByFK_Employees_Employees[0];
                }
...
namespace NorthwindDatabaseApp.NorthwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NorthwindDatabaseApp.Properties.Settings.Default.NorthwindConnectionString;
        }
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([LastName], [FirstName], [Title], [TitleOfCourtesy], [BirthDate], [HireDate], [Address], [City], [Region], [PostalCode], [Country], [HomePhone], [Salary], [Extension], [Photo], [Notes], [ReportsTo], [PhotoPath]) VALUES (@LastName, @FirstName, @Title, @TitleOfCourtesy, @BirthDate, @HireDate, @Address, @City, @Region, @PostalCode, @Country, @HomePhone, @Salary, @Extension, @Photo, @Notes, @ReportsTo, @PhotoPath);
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Salary, Extension, Photo, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [T" +
                ...
                ", [PostalCode] = @PostalCode, [Country] = @Country, [HomePhone] = @HomePhone, [S" +
                "alary] = @Salary, [Extension] = @Extension, [Photo] = @Photo, [Notes] = @Notes, " +
                "[ReportsTo] = @ReportsTo, [PhotoPath] = @PhotoPath WHERE (([EmployeeID] = @Origi" +
                ...
                "= @Original_HomePhone)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Sala" +
                "ry] = @Original_Salary)) AND ((@IsNull_Extension = 1 AND [Extension] IS NULL) OR" +
                " ([Extension] = @Original_Extension)) AND ((@IsNull_ReportsTo = 1 AND [ReportsTo" +
                "] IS NULL) OR ([ReportsTo] = @Original_ReportsTo)) AND ((@IsNull_PhotoPath = 1 A" +
                "ND [PhotoPath] IS NULL) OR ([PhotoPath] = @Original_PhotoPath)));\r\nSELECT Employ" +
                "eeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address," +
                " City, Region, PostalCode, Country, HomePhone, Salary, Extension, Photo, Notes, " +
                "ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = @EmployeeID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDa" +
                "te, Address, City, Region, PostalCode, Country, HomePhone, Salary, Extension, Ph" +
                "oto, Notes, ReportsTo, PhotoPath FROM dbo.Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_ReportsTo, 
                    string Original_PhotoPath) {
            return this.Update(LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Salary, Extension, Photo, Notes, ReportsTo, PhotoPath, Original_EmployeeID, Original_LastName, Original_FirstName, Original_Title, Original_TitleOfCourtesy, Original_BirthDate, Original_HireDate, Original_Address, Original_City, Original_Region, Original_PostalCode, Original_Country, Original_HomePhone, Original_Salary, Original_Extension, Original_ReportsTo, Original_PhotoPath, Original_EmployeeID);
        }
    }
